<template>
  <div class="about">
    <div id="map3dContainer" class="fullWindow" />
  </div>
</template>
...
export default {
  ...
  created() {},
  mounted() {
    this.$GeoworldLib.createInstance('map3dContainer', {
      sdkType: 'release',
      configLink: './static/gis/sceneConfig.json',
      gisserver: 'http://websdk.terra-it.cn'
    }, (e) => {
      this.earthCtrl = e
      this.flowLineState()
    })
  ...
  methods: {
    getOption() {
      ...
      var option = {
        animation: false,
        backgroundColor: 'rgba(17, 19, 42, 0)',
        GLMap: {},
        legend: [],
        xAxis: {
          show: false,
    ...
    flowLineState() {
      ...
      this.earthCtrl.factory.createEChartLayer(options)
    }
  }
}
</script>
